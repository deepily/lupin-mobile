# Post-Game Retrospective for Lupin Mobile
...
This slash command is a **reference wrapper** that reads the canonical workflow (`workflow/post-game.md`) on every invocation. The canonical doc is project-agnostic; this wrapper injects lupin-mobile paths + the [LUPIN-MOBILE] prefix. Other projects use their own thin wrappers.
